...
{
    public class IdealProcessor : IBackgroundProcessor
    {
        private Regex regex = new Regex(@"\|d6\|Ideal\|");

        public BackgroundSection Section { get; } = BackgroundSection.Ideal;
