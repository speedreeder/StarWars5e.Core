    ...
    public class ReferenceTableProcessor : BaseProcessor<ReferenceTable>
    {
        public override Task<List<ReferenceTable>> FindBlocks(List<string> lines)
        {
            var referenceTables = new List<ReferenceTable>
            {
                ...
                ParseTable(lines, Localization.ReferenceTableStartingLineStartingWealthByClass, Localization.ReferenceTableNameStartingWealthByClass, ContentType.Core),
                ...
                ParseTable(lines, Localization.ReferenceTableStartingLineStarshipSizeConstructionWorkforce, Localization.ReferenceTableNameStarshipSizeConstructionWorkforce, ContentType.Core),
                ...
                ParseTable(lines, Localization.ReferenceTableStartingLineModificationTierRequirementDC, Localization.ReferenceTableNameModificationTierRequirementDC, ContentType.Core),
                ParseTable(lines, Localization.ReferenceTableStartingLineModificationSlotsAtTierZero, Localization.ReferenceTableNameModificationSlotsAtTierZero, ContentType.Core),
                ...
                ParseTable(lines, Localization.ReferenceTableStartingLineStarshipSizeBaseArmorClass, Localization.ReferenceTableNameStarshipSizeBaseArmorClass, ContentType.Core),
                ...
                ParseTable(lines, Localization.ReferenceTableStartingLineStarshipSizeBaseFlyingSpeed, Localization.ReferenceTableNameStarshipSizeBaseFlyingSpeed, ContentType.Core),
                ...
                ParseTable(lines, Localization.ReferenceTableStartingLineSampleRealspaceTravelTimes, Localization.ReferenceTableNameSampleRealspaceTravelTimes, ContentType.Core),
                ParseTable(lines, Localization.ReferenceTableStartingLineSampleHyperspaceTravelTimes, Localization.ReferenceTableNameSampleHyperspaceTravelTimes, ContentType.Core),
                ParseTable(lines, Localization.ReferenceTableStartingLineAstrogationTimeTaken, Localization.ReferenceTableNameAstrogationTimeTaken, ContentType.Core),
                ...
                ParseTable(lines, Localization.ReferenceTableStartingLineStarshipSizeRepairTime, Localization.ReferenceTableNameStarshipSizeRepairTime, ContentType.Core),
                ParseTable(lines, Localization.ReferenceTableStartingLineStarshipSizeMaintenanceTime, Localization.ReferenceTableNameStarshipSizeMaintenanceTime, ContentType.Core),
                ...
                ParseTable(lines, Localization.ReferenceTableStartingLineSystemDamage, Localization.ReferenceTableNameSystemDamage, ContentType.Core),
                ParseTable(lines, Localization.ReferenceTableStartingLineStarshipSizeMaximumSuites, Localization.ReferenceTableNameStarshipSizeMaximumSuites, ContentType.Core, 2),
                ...
                ParseTable(lines, Localization.ReferenceTableStartingLineCyberneticAugmentationSideEffects, Localization.ReferenceTableNameCyberneticAugmentationSideEffects, ContentType.Core)
            };
