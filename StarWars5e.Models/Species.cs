...
{
    /// <summary>
    /// The representation of the species that is stored in the Sw5e Database
    /// </summary>
    public class Species : TableEntity, ISpecies
    {
        /// <summary>
        ...
        public Species(string partitionKey, string rowKey = "")
        {
            this.PartitionKey = partitionKey; // this is either core or expanded or community
